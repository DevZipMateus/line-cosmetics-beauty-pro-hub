    ...
    <section id="contato" className="relative section-padding overflow-hidden">
      ...
      <div className="container-custom px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 gap-8 md:gap-12">
            ...
            <div className="flex items-start gap-3 sm:gap-4">
              ...
              <div>
                ...
                <a
                  ...
                  className="text-sm sm:text-base text-muted-foreground hover:text-primary transition-colors font-body"
                >
                  (51) 99823-2246
                </a>
              </div>
            ...
            <div className="flex items-start gap-3 sm:gap-4">
              ...
              <div>
                ...
                <a
                  ...
                  className="text-sm sm:text-base text-muted-foreground hover:text-primary transition-colors font-body break-all"
                >
          ...
          {/* Map */}
          <div className="bg-background rounded-xl sm:rounded-2xl overflow-hidden shadow-sm h-[300px] sm:h-[400px] md:h-full md:min-h-[400px]">
            <iframe
